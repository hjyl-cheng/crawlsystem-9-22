...
else install -d -m 0750 "/srv/crawl-data/clickhouse"; python3 -c 'import os,sys; os.chown(sys.argv[1],int(sys.argv[2]),int(sys.argv[3]))' "/srv/crawl-data/clickhouse" 101 101; fi
